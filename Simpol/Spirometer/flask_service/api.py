...
DEFAULT_INF = "zbattiz"
DEFAULT_MEME = "sustainability"
DEFAULT_CAT = "Sustainable Finance"
EXTERNAL_CAT = ["finance", "climate", "innovation", "sustainability", "socialimpact"]
...
def add_new_user(username):
    try:
        tdata = ClientTwitter.accumulate_auser_tweets(username, nlatest=200)
    except Exception:
    ...
    print("New influencer on the board: {} {} {} {}".format(username, ntweets, nmappings, nwords))
...
def get_user_score(username):
    print("JSON query for Influencer {}".format(username))
...
def refresh():
    ...
    for inf in debates.keys():
        ...
        print('{} {} {} {}'.format(inf, src, ntweets, nmappings, nwords))
